...
(function () {
    ...
    var define = null;
    var exports = _src_scheduler_providers_crontab_CronCommand != null ? _src_scheduler_providers_crontab_CronCommand : {};
...
;
    ...
    if (_src_scheduler_providers_crontab_CronCommand === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_providers_crontab_CronCommand) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_scheduler_providers_crontab_CronComment != null ? _src_scheduler_providers_crontab_CronComment : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_scheduler_providers_crontab_CronComment === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_providers_crontab_CronComment) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_scheduler_providers_crontab_TimeRange != null ? _src_scheduler_providers_crontab_TimeRange : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_scheduler_providers_crontab_TimeRange === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_providers_crontab_TimeRange) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_scheduler_providers_crontab_TimeSlot != null ? _src_scheduler_providers_crontab_TimeSlot : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_scheduler_providers_crontab_TimeSlot === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_providers_crontab_TimeSlot) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_scheduler_providers_crontab_CronJob != null ? _src_scheduler_providers_crontab_CronJob : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_scheduler_providers_crontab_CronJob === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_providers_crontab_CronJob) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_shell_ShellUtil != null ? _src_shell_ShellUtil : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_shell_ShellUtil === module.exports) {
        // do nothing if
    } else if (__isObj(_src_shell_ShellUtil) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_scheduler_providers_crontab_CronVar != null ? _src_scheduler_providers_crontab_CronVar : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_scheduler_providers_crontab_CronVar === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_providers_crontab_CronVar) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_scheduler_providers_crontab_CronTab != null ? _src_scheduler_providers_crontab_CronTab : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_scheduler_providers_crontab_CronTab === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_providers_crontab_CronTab) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_scheduler_providers_crontab_CronTabLib != null ? _src_scheduler_providers_crontab_CronTabLib : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_scheduler_providers_crontab_CronTabLib === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_providers_crontab_CronTabLib) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_utils_CsvUtil != null ? _src_utils_CsvUtil : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_utils_CsvUtil === module.exports) {
        // do nothing if
    } else if (__isObj(_src_utils_CsvUtil) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_scheduler_providers_schtasks_SchtasksLib != null ? _src_scheduler_providers_schtasks_SchtasksLib : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_scheduler_providers_schtasks_SchtasksLib === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_providers_schtasks_SchtasksLib) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_utils_CommandUtil != null ? _src_utils_CommandUtil : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_utils_CommandUtil === module.exports) {
        // do nothing if
    } else if (__isObj(_src_utils_CommandUtil) && __isObj(module.exports)) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_scheduler_Scheduler != null ? _src_scheduler_Scheduler : {};
    var module = { exports: exports };
...
;
    ...
    if (_src_scheduler_Scheduler === module.exports) {
        // do nothing if
    } else if (__isObj(_src_scheduler_Scheduler) && __isObj(module.exports)) {
...
var NAMESPACE_DEFAULT = 'cronbee';
exports.Commands = {
    list: function (args) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var cfg, namespace, jobs;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, appcfg_1.default.fetch([])];
                    case 1:
                        cfg = _c.sent();
                        namespace = (_b = (_a = cfg.prefix) !== null && _a !== void 0 ? _a : cfg.namespace) !== null && _b !== void 0 ? _b : NAMESPACE_DEFAULT;
                        return [4 /*yield*/, Jobs.load(namespace)];
                    case 2:
                        jobs = _c.sent();
                        if (jobs.length) {
                            console.log(jobs);
    ...
    clear: function (args) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var cronbee, cfg, namespace, currentJobs;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2:
                        currentJobs = _c.sent();
                        // clear
                        return [4 /*yield*/, (0, alot_1.default)(currentJobs)
        ...
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var file, exists, cfg, namespace, config, jobs, activeJobs, inactiveJobs, _i, jobs_1, job, cronbee, currentJobs, created;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        cfg = _e.sent();
                        namespace = (_c = (_b = cfg.prefix) !== null && _b !== void 0 ? _b : cfg.namespace) !== null && _c !== void 0 ? _c : NAMESPACE_DEFAULT;
                    ...
                    case 5:
                        // clear
                        _e.sent();
                        return [4 /*yield*/, (0, alot_1.default)(jobs)
...
var CommandUtil_1 = _src_utils_CommandUtil;
var DEFAULT_TIMEOUT_MINS = 2 * 60; // 2 hours
var Runner = /** @class */ (function () {
    ...
    Runner.prototype.execute = function (params) {
        var _a, _b;
        return __awaiter(this, void 0, Promise, function () {
            var task, cwd, cronbeeOptions, command, channel, started, shell, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [2 /*return*/];
                    case 2:
                        cwd = (_a = HandleArgs.extractCwdIfAny(params)) !== null && _a !== void 0 ? _a : process.cwd();
                        cronbeeOptions = HandleArgs.extractCronbeeOptionsIfAny(params);
                        command = HandleArgs.serialize(params);
    ...
    Runner.prototype.exec = function (params, opts) {
        return __awaiter(this, void 0, Promise, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var _a, _b;
                        var completed = false;
                        var shell = new shellbee_1.Shell(params);
                        var promise = shell.run();
                        var timer;
                        var timeout = Number((_b = (_a = opts === null || opts === void 0 ? void 0 : opts.timeout) !== null && _a !== void 0 ? _a : DEFAULT_TIMEOUT_MINS) !== null && _b !== void 0 ? _b : 0);
                        if (timeout > 0) {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            completed = true;
                                            return [4 /*yield*/, shell.terminate()];
                                        case 1:
                                            _a.sent();
                                            shell.lastCode = -1;
...
(function (HandleArgs) {
    ...
    function extractCronbeeOptionsIfAny(args) {
        var opts = {};
        for (var i = 0; i < args.length; i++) {
            var str = args[i];
            var rgxKey = /[\-]{1,2}cronbee\-(?<key>.+)/i;
            var match = rgxKey.exec(str);
            if (match) {
    ...
    HandleArgs.extractCronbeeOptionsIfAny = extractCronbeeOptionsIfAny;
