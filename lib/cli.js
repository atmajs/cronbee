                ...
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, alot_1.default(jobs)
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, cronbee.ensure({
...
var shellbee_1 = require("shellbee");
var atma_server_monit_1 = require("atma-server-monit");
var atma_utils_1 = require("atma-utils");
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/];
                    case 2:
                        cwd = HandleArgs.extractCwdIfAny(args);
                        command = HandleArgs.serialize(args);
                        atma_server_monit_1.Monit.startLogger({
                            directory: atma_utils_1.class_Uri.combine(cwd, '/logs/monit')
                        });
                        channel = atma_server_monit_1.Monit.createChannel('cronbee', {
                            fields: [
                                {
                                    name: 'Date',
                                    type: 'date',
                    ...
                    case 5:
                        ...
                        channel.writeRow([
                            ...
                            500,
                            '',
                            (_a = error_1.stack) !== null && _a !== void 0 ? _a : error_1.message,
                        ]);
                        channel.flush();
                        return [3 /*break*/, 7];
